...
public class DB extends SQLiteOpenHelper {
    ...
    private void addDefaultGroupsUsersMediaFeeds(SQLiteDatabase db) {
        ...
        mindcrackGroup.setUsers(new SparseArray<User>() {{
                put(0, new User("Adlingtont", "https://lh4.googleusercontent.com/-6DIByMHfFbw/AAAAAAAAAAI/AAAAAAAAAAA/GMmF_KtKbtQ/photo.jpg", new SparseArray<YoutubeFeed>() {{
                    ...
                    put(3, new YoutubeFeed("Activity", "null", "UCfhM3yJ8a_sAJj0qOKb40gw", null, 1));
                }}, new ArrayList<Group>() {{add(mindcrackGroup); }}));

                put(1, new User("AnderZEL", "https://lh3.googleusercontent.com/-3PhwKIB2SZQ/AAAAAAAAAAI/AAAAAAAAAAA/aUoAYV_j-iI/photo.jpg", new SparseArray<YoutubeFeed>() {{
                        ...
                        put(2, new YoutubeFeed("Activity", "null", "UC-_VTaWqRsZ1nzZLHQIGwQA", null, 1));
                }}, new ArrayList<Group>() {{add(mindcrackGroup); }}));

            put(2, new User("Arkas", "https://lh6.googleusercontent.com/-Tef2i7GdFqQ/AAAAAAAAAAI/AAAAAAAAAAA/7MuQK1LEUq8/photo.jpg", new SparseArray<YoutubeFeed>() {{
                         ...
                         put(2,new YoutubeFeed("Activity", "null", "UCStPXwuYhdUu-B6fkVgi3vQ", null, 1));
                }}, new ArrayList<Group>() {{add(mindcrackGroup); }}));

            put(3, new User("Aureylian", "https://lh6.googleusercontent.com/-M0gttE6PTjI/AAAAAAAAAAI/AAAAAAAAAAA/7mbiZA77004/photo.jpg", new SparseArray<YoutubeFeed>() {{
                         ...
                         put(2,new YoutubeFeed("Activity", "null", "UCM2FHDmMP92caH9aK7RwEdw", null, 1));
                }}, new ArrayList<Group>() {{add(mindcrackGroup); }}));

            put(4, new User("AvidyaZen", "https://lh4.googleusercontent.com/-b4Bsg4yjL-E/AAAAAAAAAAI/AAAAAAAAAAA/6bNDEdr1ftk/photo.jpg", new SparseArray<YoutubeFeed>() {{
                        ...
                        put(3,new YoutubeFeed("Activity", "null", "UCDREKsabG-MOTPxmJOHctEw", null, 1));
                }}, new ArrayList<Group>() {{add(mindcrackGroup); }}));

            put(5, new User("BdoubleO100", "https://lh3.googleusercontent.com/-N9bzILzOWE8/AAAAAAAAAAI/AAAAAAAAAAA/tE8mBnO9E-M/photo.jpg", new SparseArray<YoutubeFeed>() {{
                         ...
                         put(2,new YoutubeFeed("Activity", "null", "UClu2e7S8atp6tG2galK9hgg", null, 1));
                }}, new ArrayList<Group>() {{add(mindcrackGroup); }}));

            put(6, new User("BlameTheController", "https://lh3.googleusercontent.com/-MHIPpVzLK7U/AAAAAAAAAAI/AAAAAAAAAAA/XHj6X59K2ko/photo.jpg", new SparseArray<YoutubeFeed>() {{
                         ...
                         put(2,new YoutubeFeed("Activity", "null", "UCmSwqv2aPbuOGiuii2TeaLQ", null, 1));
                }}, new ArrayList<Group>() {{add(mindcrackGroup); }}));

            put(7, new User("Coestar", "https://lh6.googleusercontent.com/-3KtWXObWKRs/AAAAAAAAAAI/AAAAAAAAAAA/XYDY6AF-Yb8/photo.jpg", new SparseArray<YoutubeFeed>() {{
                         ...
                         put(2,new YoutubeFeed("Activity", "null", "UCf-p8DeUzTqmsGW1tFOArTg", null, 1));
                }}, new ArrayList<Group>() {{add(mindcrackGroup); }}));

            }});

        roosterTeethGroup.setUsers(new SparseArray<User>() {{
            put(0, new User("Rooster Teeth", "https://lh6.googleusercontent.com/-hddEYyXVeZM/AAAAAAAAAAI/AAAAAAAAAAA/ghwEL1-FHdE/photo.jpg", new SparseArray<YoutubeFeed>() {{
                     ...
                     put(2,new YoutubeFeed("Activity", "null", "UCzH3iADRIq1IJlIXjfNgTpA", null, 1));
                }}, new ArrayList<Group>() {{add(roosterTeethGroup); }}));

            put(1, new User("LetsPlay", "https://lh5.googleusercontent.com/-f70aQff_iKE/AAAAAAAAAAI/AAAAAAAAAAA/-R40EvoOKf0/photo.jpg", new SparseArray<YoutubeFeed>() {{
                     ...
                     put(2,new YoutubeFeed("Activity", "null", "UCkxctb0jr8vwa4Do6c6su0Q", null, 1));
                }}, new ArrayList<Group>() {{add(roosterTeethGroup); }}));

            put(2, new User("The Know", "https://lh5.googleusercontent.com/-0lKHa9Wjo54/AAAAAAAAAAI/AAAAAAAAAAA/fVDFDWwii7A/photo.jpg", new SparseArray<YoutubeFeed>() {{
                    ...
                    put(1,new YoutubeFeed("Activity", "null", "UC4w_tMnHl6sw5VD93tVymGw", null, 1));
                }}, new ArrayList<Group>() {{add(roosterTeethGroup); }}));

            put(3, new User("The Slow Mo Guys", "https://lh3.googleusercontent.com/-hdZED2lNuKE/AAAAAAAAAAI/AAAAAAAAAAA/ppDB-or2f7I/photo.jpg", new SparseArray<YoutubeFeed>() {{
                    ...
                    put(3,new YoutubeFeed("Activity", "null", "UCUK0HBIBWgM2c4vsPhkYY4w", null, 1));
                }}, new ArrayList<Group>() {{add(roosterTeethGroup); }}));
